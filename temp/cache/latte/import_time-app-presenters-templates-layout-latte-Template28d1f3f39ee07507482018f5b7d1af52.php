<?php
// source: /home/vencs88/public_html/import_time/app/presenters/templates/@layout.latte

class Template28d1f3f39ee07507482018f5b7d1af52 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('13ee31eceb', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbe4671ec652_head')) { function _lbe4671ec652_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb503be9b662_scripts')) { function _lb503be9b662_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
