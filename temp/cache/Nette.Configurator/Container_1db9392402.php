<?php
// source: /home/vencs88/public_html/import_time/app/config/config.neon 
// source: /home/vencs88/public_html/import_time/app/config/config.local.neon 

class Container_1db9392402 extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'26_App_Model_ImportTimeManager',
					'application.1',
					'application.2',
					'application.3',
					'application.4',
			...
			'App\Model\ImportTimeManager' => array(
				1 => array('26_App_Model_ImportTimeManager'),
			),
		...
		'services' => array(
			...
			'26_App_Model_ImportTimeManager' => 'App\Model\ImportTimeManager',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/home/vencs88/public_html/import_time/app',
			'wwwDir' => '/home/vencs88/public_html/import_time/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/home/vencs88/public_html/import_time/app/../temp',
		));
	}
	...
	/**
	 * @return App\Model\ImportTimeManager
	 */
	public function createService__26_App_Model_ImportTimeManager()
	{
		$service = new App\Model\ImportTimeManager($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/home/vencs88/public_html/import_time/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/home/vencs88/public_html/import_time/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/vencs88/public_html/import_time/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=sam', 'root', 'Standa_8888', array('lazy' => TRUE));
	...
	{
		return new Container_1db9392402_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_1db9392402_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_1db9392402 $container)
	{
